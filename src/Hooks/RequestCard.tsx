                                                        ...
                                                        <>
                                                            {isInstructor ?
                                                                ...
                                                                <div onClick={() => DeleteBtn(e.id)}
                                                                    className="cursor-pointer h-6 w-20 mr-3  rounded-md text-white text-center text-sm bg-red-600"> حذف
                                                                </div>
                                                            }

                                                            {
                                                                isInstructor ?
                                                                    <div>
                                                                        <button type="button" onClick={() => input('true', e.id)}
                                                                            className="h-6 w-20 mr-3  rounded-md text-white text-center text-sm bg-blue-200  " disabled > قبول
                                                                        </button>
                                                                        <button onClick={() => input('false', e.id)}
                                                                            className=" h-6 w-20 mr-3  rounded-md text-white text-center text-sm bg-red-200" disabled> رفض
                                                                        </button>
                                                                    </div>
                                                                    :
                                                                    ''
                                                            ...
                                                            <>
...

                                                                {
                                                                    isInstructor ?
                                                                        <div>
                                                                            <button type="button" onClick={() => input('true', e.id)}
                                                                                className="h-6 w-20 mr-3  rounded-md text-white text-center text-sm bg-blue-600  "  > قبول
                                                                            </button>
                                                                            <button onClick={() => input('false', e.id)}
                                                                                className=" h-6 w-20 mr-3  rounded-md text-white text-center text-sm bg-red-600" > رفض
                                                                            </button>
                                                                        </div>
                                                                        :
                                                                        ''
